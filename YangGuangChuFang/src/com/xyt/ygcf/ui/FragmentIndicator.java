...
/**
 * @author komorilee 功能描述：自定义底部工具栏
 */
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	// private static final int COLOR_UNSELECT = Color.argb(100, 0xff, 0xff,
	// 0xff);
	private static final int COLOR_UNSELECT = Color.rgb(145, 146, 145);
	// private static final int COLOR_SELECT = Color.WHITE; //f88625
	private static final int COLOR_SELECT = Color.rgb(248, 134, 37); // f88625
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.ic_home_focused, R.string.tab_home, COLOR_SELECT, TAG_ICON_0,
				TAG_TEXT_0);
		...
		mIndicators[1] = createIndicator(R.drawable.ic_near_normal, R.string.tab_nearby, COLOR_UNSELECT, TAG_ICON_1,
				TAG_TEXT_1);
		...
		mIndicators[2] = createIndicator(R.drawable.ic_search_normal, R.string.tab_search, COLOR_UNSELECT, TAG_ICON_2,
				TAG_TEXT_2);
		...
		mIndicators[3] = createIndicator(R.drawable.ic_my_normal, R.string.tab_my, COLOR_UNSELECT, TAG_ICON_3,
				TAG_TEXT_3);
		...
		mIndicators[4] = createIndicator(R.drawable.ic_more_normal, R.string.tab_more, COLOR_UNSELECT, TAG_ICON_4,
				TAG_TEXT_4);
	...
	public static void setIndicator(int which) {
		...
		switch (mCurIndicator) {
			...
			case 1:
				...
				prevIcon.setImageResource(R.drawable.ic_near_normal);
			...
			case 3:
				...
				prevIcon.setImageResource(R.drawable.ic_my_normal);
				prevText = (TextView) mIndicators[mCurIndicator].findViewWithTag(TAG_TEXT_3);
				prevText.setTextColor(COLOR_UNSELECT);
				break;
			case 4:
				prevIcon = (ImageView) mIndicators[mCurIndicator].findViewWithTag(TAG_ICON_4);
				prevIcon.setImageResource(R.drawable.ic_more_normal);
				prevText = (TextView) mIndicators[mCurIndicator].findViewWithTag(TAG_TEXT_4);
				prevText.setTextColor(COLOR_UNSELECT);
				break;
		}
		...
		switch (which) {
			...
			case 1:
				...
				currIcon.setImageResource(R.drawable.ic_near_focused);
			...
			case 3:
				...
				currIcon.setImageResource(R.drawable.ic_my_focused);
				currText = (TextView) mIndicators[which].findViewWithTag(TAG_TEXT_3);
				currText.setTextColor(COLOR_SELECT);
				break;
			case 4:
				currIcon = (ImageView) mIndicators[which].findViewWithTag(TAG_ICON_4);
				currIcon.setImageResource(R.drawable.ic_more_focused);
				currText = (TextView) mIndicators[which].findViewWithTag(TAG_TEXT_4);
				currText.setTextColor(COLOR_SELECT);
				break;
		}
	...
	public void onClick(View v) {
		if (mOnIndicateListener != null) {
			...
			switch (tag) {
				...
				case 4:
					if (mCurIndicator != 4) {
						mOnIndicateListener.onIndicate(v, mCurIndicator, 4);
						setIndicator(4);
					}
					break;
				default:

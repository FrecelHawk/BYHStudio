package com.baiyuhui.huangyan.views;
...
import com.baiyuhui.huangyan.util.SharedPrefUtil;
 ...
 * @version 1.0
 */
public class LikeNeteasePull2RefreshListView extends ListView implements OnScrollListener , ICheckIsNeededRefresh{
	...
	private Runnable mLoadCheckRunnable = new Runnable() {
		...
		public void run() {
			if(mLastComparedDiffMillis < mUpdateIntervalMillis){
				LikeNeteasePull2RefreshListView.this.postDelayed(mCheckRefRunnable,
...
//			System.out.println(mLabel + "mCheckRefRunnable runable checkRefresh");
	...
	public LikeNeteasePull2RefreshListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {

...
import com.baiyuhui.huangyan.adapter.BenefitAdapter;
 ...
 * 
 */
public class HomeBenefitActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.home_benefit);
		initViews();
		HttpGet(1, 3);
	...
	private void initViews() {
		...
		mListView = (SingleLayoutListView) findViewById(R.id.benefit_list);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent it = new Intent(HomeBenefitActivity.this,
						HomeBenefitDetails.class);
				...
				HomeBenefitActivity.this.startActivity(it);
			}
		});
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				adapter = new BenefitAdapter(HomeBenefitActivity.this,
						listDatas);
	...
	private void HttpGet(int num, final int type) {
		...
		client.get(MyUrl.BENEFIT + "?page=" + num + "&contenttype=3",
				new TextHttpResponseHandler() {

					@Override
					public void onSuccess(int arg0, Header[] arg1, String arg2) {
						System.out.println("请求回来的参数----->公益" + arg2);

 ...
 * 
 */
public class HomeSchoolDetails extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.home_school_details);
		initViews();
		HttpGet();
	}
	...
	private void initViews() {
		...
		schoolTitle = (TextView) findViewById(R.id.school_title);
		schoolTitle.setText(wTitle);
		schoolTime = (TextView) findViewById(R.id.school_time);
		schoolTime.setText(cDate);

...
import com.baiyuhui.huangyan.adapter.StoryAdapter;
 ...
 * 
 */
public class FindStoryActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.find_story);
		initViews();
		HttpGet(1, 3);
	...
	private void initViews() {
		...
		mListView = (SingleLayoutListView) findViewById(R.id.story_list);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent it = new Intent(FindStoryActivity.this,
						FindStoryDetails.class);
				...
				FindStoryActivity.this.startActivity(it);
			}
		});
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				adapter = new StoryAdapter(FindStoryActivity.this, listDatas);
	...
	private void HttpGet(int num, final int type) {
		...
		client.get(MyUrl.STORY + "?page=" + num + "&contenttype=4",
				new TextHttpResponseHandler() {

					@Override
					public void onSuccess(int arg0, Header[] arg1, String arg2) {
						System.out.println("请求回来的参数----->故事" + arg2);

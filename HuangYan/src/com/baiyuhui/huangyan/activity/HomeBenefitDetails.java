 ...
 * 
 */
public class HomeBenefitDetails extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.home_benefit_details);
		initViews();
		HttpGet();
	}
	...
	private void initViews() {
		...
		benefitTitle.setText(wTitle);
		benefitTime = (TextView) findViewById(R.id.benefit_time);
		benefitTime.setText(cDate);
	...
	private void HttpGet() {
		...
		client.get(MyUrl.NEWS_DETAILS + mId, new TextHttpResponseHandler() {

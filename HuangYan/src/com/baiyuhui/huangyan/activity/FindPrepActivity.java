 ...
 * 
 */
public class FindPrepActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.find_perp);
		initViews();
		HttpGet();
	}
	...
	private void HttpGet() {
		...
		client.get(MyUrl.PREP, new TextHttpResponseHandler() {
